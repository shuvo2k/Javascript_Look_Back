...
> *প্রিমিটিভ ও নন-প্রিমিটিভ:* প্রিমিটিভ ডাটাটাইপ যা একটি একক ভ্যালু উপস্থাপন করে । আর নন-প্রিমিটিভ ডাটা টাইপ উপস্থাপন করে মাল্টিভ্যালুড ডাটা ।
...
* *অবজেক্ট:* জাভাস্ক্রিপ্টে সাধারণত কোঁকড়া বক্রবন্ধনী বা কারলি-ব্রেস এর মাধ্যমে অবজেক্ট ডিফাইন করা হয় । অবজেক্ট সাধারণত কোন এনটিটির প্রপার্টি এবং ফাংশনালিটি ডিফাইন করতে ব্যাবহার করা হয় । ES6 এ class ডিফাইন করা যায় অর্থাৎ  class এর ইনিস্টান্স দ্বারা অবজেক্ট তৈরি করা যায় ।
```
...
## কন্ডিশনের মারপ্যাঁচ 
কিছু ক্রাইটেরিয়া এর উপর ডিপেন্ড করে কন্ডিশন সত্য অথবা মিথ্যা হয় । জাভাস্ক্রিপ্টে if,else if, else স্টেটমেন্ট
এর ভেতরে আমরা কন্ডিশন ডিফাইন করে আমরা বিভিন্ন কাজ করতে পারি । আমরা চাইলে একটা স্টেটমেন্ট এর ভেতরে আরও কন্ডিশনাল স্টেটমেন্ট লিখতে পারি , একে সাধারণত নেস্টেড কন্ডিশনাল স্টেটমেন্ট বলে ।  
```
//লিপ ইয়ার চেক ইফ,ইলস ইফ, ইলস কন্ডিশনের মাধ্যমে 
let year = 2002
if (year % 4 == 0){
...
//নেস্টড কন্ডিশনের মাধ্যমে তিনটি সংখ্যার মধ্যে বড় সংখ্যা চেক করা
let a = 56;
let b = 45;
let c = 78;
...
if(a > b){
  if(a>c){
    console.log(`large number is a = ${a}.`);
  }
  else{
    console.log(`large number is c = ${c}.`);
  }
  else if(b>c){
    console.log(`large number is b = ${b}.`);
  }
  else{
    console.log(`large number is c = ${c}.`);
  }
...
```
> আমরা বিভিন্ন অপারেটর ব্যাবহার করে কন্ডিশন ডিফাইন করে থাকি । 
